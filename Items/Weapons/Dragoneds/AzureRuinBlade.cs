...
{
    /// <summary>
    /// 蔚蓝毁刃 —— 超级毕业大刀，白蓝海洋主题，挥动时释放巨型潮汐剑气
    /// </summary>
    ...
    public class AzureRuinBladeSwing : ModProjectile
    {
        public override string Texture
            => "AncientChineseMythology/Items/Weapons/Dragoneds/AzureRuinBlade";
                ...
                case Stage.Execute:
                    ...
                    if (!_waveFired && Timer >= execDur * 0.40f) {
                        ...
                        Projectile.NewProjectile(Owner.GetSource_ItemUse(Owner.HeldItem),
                            ...
                            (int)(Owner.HeldItem.damage * 1.35f),
                            Owner.HeldItem.knockBack * 0.6f, Owner.whoAmI);
                        SoundEngine.PlaySound(SoundID.Item85, Owner.position);
                    }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            if (CurrentStage == Stage.Execute) {
                ...
                sb.Draw(sg, Projectile.Center - Main.screenPosition, null,
                    new Color(80, 200, 255) * 0.65f * pulse, Projectile.rotation + rotOff,
    ...
    public class AzureRuinTidal : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            float scaleX = MathHelper.Lerp(1.85f, 0.55f, ACMUtils.QuadIn(life));
            float scaleY = MathHelper.Lerp(0.68f, 0.22f, ACMUtils.QuadIn(life));
            ...
            sb.Draw(tex, Projectile.Center - Main.screenPosition, null,
                new Color(50, 200, 255) * alpha, Projectile.rotation,
                new Vector2(tex.Width * 0.5f, tex.Height * 0.5f),
                new Vector2(scaleX, scaleY), SpriteEffects.None, 0);
            sb.Draw(tex, Projectile.Center - Main.screenPosition, null,
                new Color(200, 245, 255) * (alpha * 0.45f), Projectile.rotation + 0.05f,
                new Vector2(tex.Width * 0.5f, tex.Height * 0.5f),
                new Vector2(scaleX * 0.75f, scaleY * 0.70f), SpriteEffects.None, 0);

            Vector2 front = Projectile.Center + Projectile.velocity.SafeNormalize(Vector2.Zero) * 55f;
            sb.Draw(sg, front - Main.screenPosition, null,
                new Color(210, 248, 255) * alpha * 0.80f, 0f,
                new Vector2(sg.Width * 0.5f, sg.Height * 0.5f),
