...
{
    internal class GoldenStickSpearProjectile : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source) {
            ...
            if (CurrentAttack == AttackType.Spin) {
                ...
                InitialAngle = targetAngle; //刺击直接指向目标角度
            }
        }
        ...
        public override bool PreDraw(ref Microsoft.Xna.Framework.Color lightColor) {
            ...
            Color color = Color.DarkGoldenrod * 0.24f;
            Color color1 = Color.Gold * 0.12f;
            ...
            if (CurrentAttack == AttackType.Thrust
                ...
                sb.Draw(spikeTexture, spikePosition - Main.screenPosition, null, Color.Goldenrod, Projectile.rotation, new Vector2(spikeTexture.Width / 2, spikeTexture.Height / 2), 1.6f, effects_Thrust, 0f);
            }
