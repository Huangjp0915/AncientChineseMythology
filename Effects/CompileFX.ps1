...
#   pwsh Assets/Effects/CompileFX.ps1 DestroyerBeam
#   pwsh Assets/Effects/CompileFX.ps1 DestroyerBeam TwinsDeathRayBeam   #多个
#   pwsh Assets/Effects/CompileFX.ps1 Destroyer*                        #通配
# 批量补齐（仅编译缺少 .fxc/.xnb 的，向后兼容旧行为）：
#   pwsh Assets/Effects/CompileFX.ps1
# 全量强制重编译：
#   pwsh Assets/Effects/CompileFX.ps1 -All
